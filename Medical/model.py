...
class CGAN(object):
  ...
  def build_model(self):
    ...
    with tf.name_scope('g_loss'):
        ...
        self.g_loss_content = 100 * self.g_loss_content_grad  + 1*self.g_loss_content_int
        ...
        self.g_loss_total=10*self.g_loss_grad+1*self.g_loss_int+10*self.g_loss_content

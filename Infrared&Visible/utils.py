  ...
  if config.is_train:
    for i in range(len(data)):
      ...
      for x in range(0, h-config.image_size+1, config.stride):
        ...
        print(len(sub_input_sequence))   ###number of patch
...
def mean_filter(input):
    # filter=tf.reshape(tf.constant([[0.04,0.04,0.04,0.04,0.04],[0.04,0.04,0.04,0.04,0.04],[0.04,0.04,0.04,0.04,0.04],[0.04,0.04,0.04,0.04,0.04],[0.04,0.04,0.04,0.04,0.04]]),[5,5,1,1])
    # mean=tf.nn.conv2d(input,filter,strides=[1,1,1,1], padding='SAME')
    filter=tf.reshape(tf.constant([[0.11,0.11,0.11],[0.11,0.11,0.11],[0.11,0.11,0.11]]),[3,3,1,1])
    mean=tf.nn.conv2d(input,filter,strides=[1,1,1,1], padding='SAME')
    # blur=tf.nn.conv2d(blur,filter,strides=[1,1,1,1], padding='SAME')
    # diff=tf.abs(input-blur)
    return mean
